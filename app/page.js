  ...
  return (
    <>
      <div className="flex justify-center flex-col gap-4 items-center text-white h-[44vh] px-5 md:px-0 text-xs md:text-base ">
        <div className="font-bold flex gap-6 md:gap-20 md:text-5xl justify-center items-center text-3xl">Buy Me a Chai <span><img className="inverImg" src="/tea.gif" width={88} alt="" /></span></div>
        <p className="text-center md:text-left">
          A crowdfunding platform for creators. Get funded by your fans and followers. Start Now!
        </p>
        <p className="text-center md:text-left">
          A place Where fans can Buy you a Chai
        </p>
        <div>
          <Link href={"/login"}>
      ...
      <div className="text-white container mx-auto pb-32 pt-14 px-10">
        ...
        <div className="flex gap-5 justify-around ">
          <div className="item space-y-3 flex flex-col items-center justify-center">
            <img className="item bg-slate-400 rounded-full p-2 text-black" width={88} src="/man.gif" alt="" />
            <p className="font-bold text-center"> Fans wants to Help</p>
            <p className=" text-center">Your Fans are Available for You to Help You</p>
          </div>
          <div className="item space-y-3 flex flex-col items-center justify-center">
            <img className="item bg-slate-400 rounded-full p-2 text-black" width={88} src="/coin.gif" alt="" />
            <p className="font-bold text-center"> Fans wants to Help</p>
            <p className=" text-center">Your Fans are Available for You to Help You</p>
          </div>
          <div className="item space-y-3 flex flex-col items-center justify-center">
            <img className="item bg-slate-400 rounded-full p-2 text-black" width={88} src="/group.gif" alt="" />
            <p className="font-bold text-center"> Fans wants to Help</p>
            <p className=" text-center">Your Fans are Available for You to Help You</p>
          </div>
        </div>
...
<div className="w-[90%] h-[40vh] md:w-[50%] md:h-[40vh] lg:w-[50%] lg:h-[40vh] xl:w-[50%] xl:h-[40vh]">
    <iframe  className='w-full h-full'src="https://www.youtube.com/embed/QtaorVNAwbI?si=RbLHX8IWyqbjsx9N" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    </div>
      </div>
    </>
  );
