    ...
    return (
        <>
            ...
            <div className='cover w-full bg-red-50 relative'>
                ...
                <div className='absolute -bottom-50 right-[38%] md:right-[42%] border-white border-2 rounded-full '>
                    <img
            ...
            <div className="info flex justify-center items-center my-[204px] flex-col gap-2">
                ...
                <div className="payment flex gap-3 w-[80%] mt-11 flex-col md:flex-row ">
                    ...
                    <div className="makePayment  w-full md:w-1/2 bg-slate-900 rounded-lg text-white p-10">
                        ...
                        <div className="flex gap-2 flex-col">
                            ...
                            <button onClick={() => pay(Number.parseInt(paymentform.amount) * 100)} type="button" className=" text-white bg-gradient-to-br from-purple-900 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-base text-sm px-4 py-2.5 text-center leading-5 rounded-lg disabled:bg-slate-600 disabled:from-purple-100" disabled={paymentform.name?.length < 3 || paymentform.message?.length < 4 || paymentform.amount?.length<1}>Pay</button>
                        </div>
